...
const Signup = () => {
  ...
  const SignInSchema = Yup.object().shape({
    ...
    taille: Yup.number().required('Saisir votre taille'),
    poids: Yup.number().required('Saisir votre poids'),
        ...
        >
          {({ errors, touched }) => (
            <Form>
              ...
              <HStack>
                <FormLabel mt="1rem" htmlFor="taille">
                  Taille
                </FormLabel>
                <Field as={Input} id="taille" name="taille" type="number" />
                {errors.taille && touched.taille ? (
                  <Box fontSize="12" color="red">
                    {errors.taille}
                  </Box>
                ) : null}

                <FormLabel mt="1rem" htmlFor="poids">
                  Poids
                </FormLabel>
                <Field as={Input} id="poids" name="poids" type="number" />
